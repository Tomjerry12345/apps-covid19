package com.tomjerry.appscovid19.module.MPAndroidChart.utils;
...
public class ColorTemplate {
    ...
    public static final int[] COLOR_KASUS = {
            rgb("#f1c40f")
    };
    public static final int[] COLOR_MENINGGAL = {
            rgb("#e74c3c")
    };
    public static final int[] COLOR_SEMBUH = {
            rgb("#2ecc71")
    };
